...
%%%%%  \noindent
%%%%%  Program title: mpdata-oop\\
%%%%%  Licensing provisions: GNU GPL version 3 \citep{GPLv3}\\
%%%%%  Programming language: C++11, Python and Fortran 2008\\
%%%%%  External routines/libraries used: Blitz++, NumPy\\
%%%%%  Nature of problem: advective transport\\
%%%%%  Solution method: MPDATA\\
%%%%%  References: Smolarkiewicz 1984: A fully multidimensional positive definite advection transport algorithm with small implicit diffusion. J. Comp. Phys. 54, 325--362 \citep{Smolarkiewicz_1984}
