...
\begin{document}
    ...
    \author{~}
%    \author[1]{Sylwester Arabas\footnote{Correspondence to: S. Arabas -- sarabas@igf.fuw.edu.pl -- 0048225546827 -- University of Warsaw, Pasteura 7, 02-093 Warszawa, Poland}}
...
%    \affil[2]{PyPy Team}
  ...
  As a workaround, in in the Fortran implementation, \prog{pi()} returns a pointer to the array elements specified
    by \prog{i} and \prog{j} interpreted as (i,j) or
    (j,i) depending on the value of the argument \prog{d}.
% TODO: disucss creation of temporary arrays and disabling of vectorisation due to employment of POINTERS
  ...
  If the (positive-defined) denominator in equations \ref{eq:A} or \ref{eq:B} 
    equals zero for a given {\em i} and {\em j}, %TODO: >0 in the code
